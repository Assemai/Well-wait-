...
public:
   ...
   setSound() {
        ...
        c.loadFromFile("d:/Users/Asemai/Music/catch.ogg");
        e.loadFromFile("d:/Users/Asemai/Music/Untitled.ogg");
        g.loadFromFile("d:/Users/Asemai/Music/gameover.ogg");
        p.loadFromFile("d:/Users/Asemai/Music/pass.ogg");
        ...
        music.openFromFile("d:/Users/Asemai/Music/chukchuk.ogg");
...
int main()
{
    ...
    Texture f;
    f.loadFromFile("d:/Users/Asemai/Pictures/B.png");
    Sprite fon(f);

    Texture p, r;
    p.loadFromFile("d:/Users/Asemai/Pictures/P.png");
    r.loadFromFile("d:/Users/Asemai/Pictures/A.png");
    Player player(p, r);

    Texture eg;
    eg.loadFromFile("d:/Users/Asemai/Pictures/E.png");
    int nom[4];
    Egg egg[4];
    for (int i = 0; i < 4; i++) {
        nom[i] = i + 1;
    ...
    Texture s;
    s.loadFromFile("d:/Users/Asemai/Pictures/S.png");
    Score score(s);

    Texture up;
    up.loadFromFile("d:/Users/Asemai/Pictures/BF.png");
    Upast upast;
    upast.set(up);

    Texture l;
    l.loadFromFile("d:/Users/Asemai/Pictures/L.png");
    Sprite lose[3];
    for (int i = 0; i < 3; i++) {
        lose[i].setTexture(l);
    ...
    Texture go;
    go.loadFromFile("d:/Users/Asemai/Pictures/F.png");
    Sprite gameover(go);
